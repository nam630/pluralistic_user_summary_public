...
from openrlhf.models import BinaryLoss, LogExpLoss, PairWiseLoss, RegressionLoss, MultiHeadedClassificationLoss
...
class RewardModelTrainer(ABC):
    ...
    def __init__(
        ...
        elif loss == "multi_headed_classification":
            self.loss_fn = MultiHeadedClassificationLoss()
            self.strategy.print("Multi-headed classification loss")
