...
from openrlhf.datasets import InferenceEvalDataset, PromptDataset, SFTDataset
from openrlhf.models import Actor, get_llm_for_sequence_regression
from openrlhf.trainer import InferenceEvaluator
from openrlhf.utils import return_dataset, blending_datasets, get_strategy, get_tokenizer
...
def train(args):
    ...
    if args.critic_pretrain:
        critic = get_llm_for_sequence_regression(
            ...
            bf16=args.bf16,
            load_in_4bit=args.load_in_4bit,
            lora_rank=-1, # needs to make the rm trainable
            lora_alpha=None,
            target_modules=None,
            lora_dropout=None,
            ds_config=None,
    ...
    eval_dataset = InferenceEvalDataset(eval_data, tokenizer, strategy, input_template=args.input_template)
    
    eval_dataloader = strategy.setup_dataloader(
        eval_dataset, 1, True, shuffle=False
        )
    pretrain_dataloader = None

    # configure scheduler
    num_update_steps_per_episodes = (
        len(eval_dataset) * args.n_samples_per_prompt // args.train_batch_size * args.max_epochs
    )
    ...
    evaluator.eval(args, consumed_samples, num_update_steps_per_episodes, eval_dataloader)
