...
def train(args):
    ...
    tokenizer = get_tokenizer("meta-llama/Llama-3.1-8B-Instruct", model.model, "right", strategy, use_fast=not args.disable_fast_tokenizer)
    print("Manually set the tokenizer to be Instruct")
