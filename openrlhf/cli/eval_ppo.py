...
from openrlhf.trainer import PPOEvaluator
...
def evaluate(args):
    ...
    prompts_dataloader = strategy.setup_dataloader(
        prompts_dataset, args.micro_train_batch_size, True, True
    )
    ...
    trainer.eval(args, prompts_dataloader, pretrain_dataloader, consumed_samples, num_update_steps_per_episodes, eval_dataloader)
