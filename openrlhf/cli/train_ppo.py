...
def train(args):
    ...
    reward_optim = strategy.create_optimizer(
        reward_model, lr=args.critic_learning_rate, betas=args.adam_betas, weight_decay=args.reward_l2
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reward_l2", type=float, default=0.0, help="reward model weight decay loss")
